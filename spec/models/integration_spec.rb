...
RSpec.describe Integration, type: :model do
    ...
    describe 'validations' do
        ...
        integration = Integration.create(name: 'Test Integration' , workspace: '523123124', project: '123123123', action: 'Create a new task', wishlist: wishlist, api_token: '123123123', user: user)
        ...
        it 'is not valid if name already exists for this wishlist' do
            ...
            integration.save
            integration2 = Integration.create(name: 'Asana', workspace: '523123124', project: '123123123', action: 'Create a new task', wishlist: wishlist, api_token: '123123123', user: user)
